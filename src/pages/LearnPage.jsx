	...
	return (
		<div className="min-h-screen flex flex-col bg-white">
			...
			<main className="flex-1 mt-[72px]">
				{/* Hero Section */}
				<section className="py-16 md:py-15 px-6 w-full max-w-[1200px] text-center mx-auto">
					<h1 className="text-4xl md:text-[56px] leading-[1.1] font-display font-medium text-black mb-6">
						Crypto questions, answered
					</h1>
					<p className="text-gray-500 text-center text-lg font-body ">
							...
							<a href="#" className="group block relative rounded-2xl overflow-hidden bg-gray-5 border border-transparent hover:border-gray-20 transition-all shadow-sm hover:shadow-md">
								<div className="aspect-video w-full relative overflow-hidden">
									...
									<div className="absolute inset-0 bg-black/10 group-hover:bg-black/5 transition-colors flex items-center justify-center">
										<div className="w-16 h-16 bg-white/95 rounded-full flex items-center justify-center text-blue-600 shadow-[0_0_30px_rgba(0,0,0,0.1)] group-hover:scale-110 transition-transform">
											<PlayCircle size={32} fill="currentColor" className="text-blue-600" />
										</div>
									</div>
								</div>
								<div className="p-6 md:p-8 bg-white transition-colors">
									<span className="text-sm font-semibold text-gray-600 tracking-wider uppercase mb-3 block">
										Video Tutorial
									</span>
									<h3 className="text-3xl font-display font-medium text-black mb-4 group-hover:text-blue-600 transition-colors">
								...
								{popularArticles.map((article, i) => (
									<div key={i} className="flex flex-col">
										<a href="#" className="group py-4">
											<span className="text-xs font-semibold text-gray-500 tracking-wider uppercase mb-1 block">{article.label}</span>
											<h4 className="text-lg font-medium text-black group-hover:text-blue-600 transition-colors">{article.title}</h4>
										</a>
				...
				<section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
					<div className="mb-10  text-center md:flex-row md:items-end justify-between gap-4">
						<div>
							<h2 className="text-3xl text-center font-display font-medium mb-3 text-black">Crypto basics</h2>
							<p className="text-gray-500 text-lg">New to crypto? Not for long — start with these guides and explainers</p>
						</div>
						...
						<div className="flex flex-wrap justify-center gap-4 mb-12">
							{whatIs.map((item, i) => (
								<a
									key={i}
									href="#"
									className={`px-5 py-3 bg-white rounded-lg shadow-sm border border-transparent hover:border-gray-20 transition-all text-[15px] font-medium ${item.label === 'Crypto wallet' ? 'text-blue-600' : 'text-black hover:text-blue-600'
										}`}
								>
									{item.label}
								</a>
				...
				{/* Tips and Tutorials */}
				<section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
					<div className="mb-10 text-center md:items-end justify-between gap-4">
						<div>
							<h2 className="text-4xl font-display font-medium mb-3 text-black">Tips and tutorials</h2>
							<p className="text-gray-600 text-lg">Get practical, step-by-step answers to all things crypto</p>
						</div>
						<a href="#" className="font-semibold text-blue-600 hover:underline shrink-0">See more ›</a>
					</div>
				...
				<section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
					<div className="mb-10  text-center md:flex-row md:items-end justify-between gap-4">
						<div>
							<h2 className="text-4xl font-display font-medium mb-3 text-black">Advanced trading</h2>
							<p className="text-gray-600 text-lg">Ready to advance? Learn the tools and terminology you need to take control of your trades.</p>
						</div>
						<a href="#" className="font-semibold text-blue-600 hover:underline shrink-0">See more ›</a>
					</div>
				...
				<section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
					<div className="mb-10 text-center md:items-end justify-between gap-4">
						<div>
							<h2 className="text-4xl text-center font-display font-semibold mb-3 text-black">Futures</h2>
							<p className="text-gray-600 text-lg">New to futures trading? Get up to speed on the basics.</p>
						</div>
						<a href="#" className="font-semibold text-blue-600 hover:underline shrink-0">See more ›</a>
				...
				<section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
					<div className="mb-10 text-center md:items-end justify-between gap-4">
						<div>
							<h2 className="text-4xl font-display font-medium mb-3 text-black">All Things Wallet</h2>
							<p className="text-gray-600 text-lg">Earn yield, dive into crypto apps, control your holdings, and much more</p>
						</div>
						<a href="#" className="font-semibold text-blue-600 hover:underline shrink-0">See more ›</a>
					</div>
